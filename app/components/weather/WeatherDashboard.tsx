...
export function WeatherDashboard({
  ...
  return (
    <div className="relative mx-auto mt-8 max-w-[1400px] overflow-hidden rounded-[36px] border border-white/10 bg-slate-950/65 p-4 shadow-[0_35px_120px_rgba(2,6,23,0.75)] ring-1 ring-sky-400/10 backdrop-blur-2xl sm:p-6 md:py-12 md:px-8">
      
      <div className="relative">
        <header className="flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
          <div className="min-w-0">
            <p className="text-[10px] font-medium uppercase tracking-[0.28em] text-slate-400 sm:text-xs">Weather</p>
            <h1 className="mt-2 text-2xl font-semibold leading-[1.1] text-white sm:text-[2rem] md:text-3xl">Global forecast</h1>
          </div>

          <div className="flex flex-wrap items-center gap-2 sm:gap-3">
            <div className="inline-flex rounded-full border border-white/10 bg-slate-900 p-1 shadow-[inset_0_1px_0_rgba(255,255,255,0.06)]">
              {(["celsius", "fahrenheit"] as TemperatureUnit[]).map((option) => (
                <button
                  ...
                  className={`flex h-9 min-w-[52px] items-center justify-center rounded-full px-3 text-sm font-medium transition sm:h-10 sm:min-w-20 sm:px-4 ${
                    unit === option
                      ? "bg-slate-100 text-slate-950 shadow-none"
            ...
            <button
              ...
              className={`inline-flex items-center gap-2 rounded-full border px-3 py-2 text-xs font-medium transition sm:px-4 sm:py-2.5 sm:text-sm ${
                isCurrentLocationActive
                  ...
                  : "border-white/10 bg-slate-900 text-slate-100 hover:border-slate-500 hover:bg-slate-800"
              }`}
            >
        ...
        <section className="mt-8 grid gap-6 xl:grid-cols-[1.5fr_0.9fr]">
          <div className="flex flex-col justify-center relative min-w-0 overflow-hidden rounded-[30px] border border-white/10 bg-slate-900 p-4 shadow-[inset_0_1px_0_rgba(255,255,255,0.05)] sm:p-5 md:p-6 transition-all duration-300 ease-out hover:shadow-[inset_0_1px_0_rgba(255,255,255,0.04),0_0_12px_rgba(148,163,184,0.25),0_0_25px_rgba(148,163,184,0.08)]">
            <div className="mt-4">
              ...
              <div className="absolute right-4 top-4 min-w-[120px] rounded-2xl border border-slate-600 bg-slate-800 px-2 py-2 text-center text-[9px] font-medium uppercase tracking-[0.18em] text-slate-200 sm:right-6 sm:top-6 sm:min-w-[140px] sm:text-[10px]">
                {weather.timezone}
              </div>

            <div className="relative mt-7 flex flex-col gap-5 md:flex-row md:items-center md:justify-between">
              <div className="flex min-w-0 items-center gap-3 sm:gap-4">
                <div className="flex h-[72px] w-[72px] shrink-0 items-center justify-center rounded-[20px] border border-slate-700 bg-slate-800 text-slate-100 shadow-none sm:h-[88px] sm:w-[88px]">
              ...
              <div className="grid w-full grid-cols-3 gap-3 md:min-w-[350px] md:max-w-[380px] md:flex-1">
                <div className="rounded-2xl border border-white/10 bg-slate-800 p-3 shadow-none">
            ...
            <div className="relative mt-6 grid gap-4 border-t border-white/10 pt-5 sm:grid-cols-3">
              <div className="flex items-center justify-between gap-3 rounded-2xl border border-white/10 bg-slate-800 p-3">
          ...
          <div className="min-w-0 rounded-[30px] border border-white/10 bg-slate-900 p-4 shadow-[inset_0_1px_0_rgba(255,255,255,0.05)] sm:p-5 transition-all duration-300 ease-out hover:shadow-[inset_0_1px_0_rgba(255,255,255,0.04),0_0_12px_rgba(148,163,184,0.25),0_0_25px_rgba(148,163,184,0.08)]">
            <p className="text-xs uppercase tracking-[0.2em] text-slate-400">Forecast</p>
            <div className="mt-4 space-y-3">
              {dailyForecast.map((entry) => (
                <div key={entry.time} className="flex items-center gap-3 rounded-2xl border border-white/10 bg-slate-800 p-3 transition hover:border-slate-500 hover:bg-slate-700">
                  <div className="w-12 shrink-0 text-sm font-medium text-slate-200">{formatDayLabel(entry.time).split(",")[0]}</div>
                  <div className="flex h-10 w-10 shrink-0 items-center justify-center rounded-xl border border-slate-600 bg-slate-700 p-1.5 text-slate-100">
        ...
        <section className="mt-8 rounded-[30px] border border-white/10 bg-slate-900 p-4 shadow-[inset_0_1px_0_rgba(255,255,255,0.05)] sm:p-5 transition-all duration-300 ease-out hover:shadow-[inset_0_1px_0_rgba(255,255,255,0.04),0_0_12px_rgba(148,163,184,0.25),0_0_25px_rgba(148,163,184,0.08)]">
          ...
          <div className="mt-4 overflow-x-auto pb-2 [scrollbar-width:none] [-ms-overflow-style:none] [&::-webkit-scrollbar]:hidden">
            <div className="flex min-w-max gap-3">
              {hourlyForecast.map((entry) => (
                <div
                  key={entry.time}
                  className="w-[150px] shrink-0 rounded-2xl border border-white/10 bg-slate-800 p-3 text-center shadow-none"
                >
                  <div className="text-sm leading-relaxed text-slate-300">{formatHourLabel(entry.time)}</div>
                  <div className="mt-3 flex justify-center text-slate-100">
